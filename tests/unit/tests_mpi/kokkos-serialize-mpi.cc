...
template <typename ParamT> struct KokkosViewTest1D_MPI : KokkosViewTest<ParamT> { };
template <typename ParamT> struct KokkosViewTest2D_MPI : KokkosViewTest<ParamT> { };
template <typename ParamT> struct KokkosViewTest3D_MPI : KokkosViewTest<ParamT> { };
...
TYPED_TEST_CASE_P(KokkosViewTest1D_MPI);
TYPED_TEST_CASE_P(KokkosViewTest2D_MPI);
TYPED_TEST_CASE_P(KokkosViewTest3D_MPI);

TYPED_TEST_P(KokkosViewTest1D_MPI, test_1d_any) {
...
TYPED_TEST_P(KokkosViewTest2D_MPI, test_2d_any) {
  using namespace serialization::interface;
...
TYPED_TEST_P(KokkosViewTest3D_MPI, test_3d_any) {
  using namespace serialization::interface;
...
REGISTER_TYPED_TEST_CASE_P(KokkosViewTest1D_MPI, test_1d_any);
REGISTER_TYPED_TEST_CASE_P(KokkosViewTest2D_MPI, test_2d_any);
REGISTER_TYPED_TEST_CASE_P(KokkosViewTest3D_MPI, test_3d_any);
...
INSTANTIATE_TYPED_TEST_CASE_P(test_1d_L, KokkosViewTest1D_MPI, Test1DTypesLeft);
INSTANTIATE_TYPED_TEST_CASE_P(test_1d_R, KokkosViewTest1D_MPI, Test1DTypesRight);
INSTANTIATE_TYPED_TEST_CASE_P(test_1d_S, KokkosViewTest1D_MPI, Test1DTypesStride);
...
INSTANTIATE_TYPED_TEST_CASE_P(test_2d_L, KokkosViewTest2D_MPI, Test2DTypesLeft);
INSTANTIATE_TYPED_TEST_CASE_P(test_2d_R, KokkosViewTest2D_MPI, Test2DTypesRight);
INSTANTIATE_TYPED_TEST_CASE_P(test_2d_S, KokkosViewTest2D_MPI, Test2DTypesStride);
...
INSTANTIATE_TYPED_TEST_CASE_P(test_3d_L, KokkosViewTest3D_MPI, Test3DTypesLeft);
INSTANTIATE_TYPED_TEST_CASE_P(test_3d_R, KokkosViewTest3D_MPI, Test3DTypesRight);
INSTANTIATE_TYPED_TEST_CASE_P(test_3d_S, KokkosViewTest3D_MPI, Test3DTypesStride);
...
template <typename ParamT>
struct KokkosDynamicViewTest_MPI : KokkosViewTest<ParamT> { };

TYPED_TEST_CASE_P(KokkosDynamicViewTest_MPI);

TYPED_TEST_P(KokkosDynamicViewTest_MPI, test_dynamic_1d_MPI) {
  using namespace serialization::interface;
...
REGISTER_TYPED_TEST_CASE_P(KokkosDynamicViewTest_MPI, test_dynamic_1d_MPI);
...
INSTANTIATE_TYPED_TEST_CASE_P(
  test_dynamic_view_1_MPI, KokkosDynamicViewTest_MPI, DynamicTestTypes
);
